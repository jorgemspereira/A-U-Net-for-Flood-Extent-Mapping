...
def unet_model(n_classes=5, im_sz=160, n_channels=8, n_filters_start=32, growth_factor=2, droprate=0.1):

    # Block1
    n_filters = n_filters_start
    inputs = Input((im_sz, im_sz, n_channels), name='input')
    conv1 = Conv2D(n_filters, (3, 3), padding='same', name='conv1_1', kernel_initializer='he_uniform',
                   bias_initializer='he_uniform')(inputs)
    actv1 = LeakyReLU(name='actv1_1')(conv1)
    conv1 = Conv2D(n_filters, (3, 3), padding='same', name='conv1_2', kernel_initializer='he_uniform',
    ...
    conv2 = Conv2D(n_filters, (3, 3), padding='same', name='conv2_1', kernel_initializer='he_uniform',
                   bias_initializer='he_uniform')(pool1)
    actv2 = LeakyReLU(name='actv2_1')(conv2)
    conv2 = Conv2D(n_filters, (3, 3), padding='same', name='conv2_2', kernel_initializer='he_uniform',
    ...
    conv3 = Conv2D(n_filters, (3, 3), padding='same', name='conv3_1', kernel_initializer='he_uniform',
                   bias_initializer='he_uniform')(pool2)
    actv3 = LeakyReLU(name='actv3_1')(conv3)
    conv3 = Conv2D(n_filters, (3, 3), padding='same', name='conv3_2', kernel_initializer='he_uniform',
    ...
    conv4_0 = Conv2D(n_filters, (3, 3), padding='same', name='conv4_1', kernel_initializer='he_uniform',
                     bias_initializer='he_uniform')(pool3)
    actv4_0 = LeakyReLU(name='actv4_1')(conv4_0)
    conv4_0 = Conv2D(n_filters, (3, 3), padding='same', name='conv4_0_2', kernel_initializer='he_uniform',
    ...
    conv4_1 = Conv2D(n_filters, (3, 3), padding='same', name='conv5_1', kernel_initializer='he_uniform',
                     bias_initializer='he_uniform')(pool4_1)
    actv4_1 = LeakyReLU(name='actv5_1')(conv4_1)
    conv4_1 = Conv2D(n_filters, (3, 3), padding='same', name='conv5_2', kernel_initializer='he_uniform',
    ...
    # Block6
    n_filters *= growth_factor
    conv5 = Conv2D(n_filters, (3, 3), padding='same', name='conv6_1', kernel_initializer='he_uniform',
                   bias_initializer='he_uniform')(pool4_2)
    actv5 = LeakyReLU(name='actv6_1')(conv5)
    conv5 = Conv2D(n_filters, (3, 3), padding='same', name='conv6_2', kernel_initializer='he_uniform',
    ...
    n_filters //= growth_factor
    up6_1 = concatenate(
        [Conv2DTranspose(n_filters, (2, 2), strides=(2, 2), padding='same', name='up7')(actv5), actv4_1],
        name='concat7')
    up6_1 = BatchNormalization(name='bn7')(up6_1)
    conv6_1 = Conv2D(n_filters, (3, 3), padding='same', name='conv7_1', kernel_initializer='he_uniform',
                     bias_initializer='he_uniform')(up6_1)
    actv6_1 = LeakyReLU(name='actv7_1')(conv6_1)
    conv6_1 = Conv2D(n_filters, (3, 3), padding='same', name='conv7_2', kernel_initializer='he_uniform',
    ...
    n_filters //= growth_factor
    up6_2 = concatenate(
        [Conv2DTranspose(n_filters, (2, 2), strides=(2, 2), padding='same', name='up8')(conv6_1), actv4_0],
        name='concat8')
    up6_2 = BatchNormalization(name='bn8')(up6_2)
    conv6_2 = Conv2D(n_filters, (3, 3), padding='same', name='conv8_1', kernel_initializer='he_uniform',
                     bias_initializer='he_uniform')(up6_2)
    actv6_2 = LeakyReLU(name='actv8_1')(conv6_2)
    conv6_2 = Conv2D(n_filters, (3, 3), padding='same', name='conv8_2', kernel_initializer='he_uniform',
    ...
    # Block9
    n_filters //= growth_factor
    up7 = concatenate([Conv2DTranspose(n_filters, (2, 2), strides=(2, 2), padding='same', name='up9')(conv6_2), actv3],
                      name='concat9')
    up7 = BatchNormalization(name='bn9')(up7)
    conv7 = Conv2D(n_filters, (3, 3), padding='same', name='conv9_1', kernel_initializer='he_uniform',
                   bias_initializer='he_uniform')(up7)
    actv7 = LeakyReLU(name='actv9_1')(conv7)
    conv7 = Conv2D(n_filters, (3, 3), padding='same', name='conv9_2', kernel_initializer='he_uniform',
    ...
    # Block10
    n_filters //= growth_factor
    up8 = concatenate([Conv2DTranspose(n_filters, (2, 2), strides=(2, 2), padding='same', name='up10')(conv7), actv2],
                      name='concat10')
    up8 = BatchNormalization(name='bn10')(up8)
    conv8 = Conv2D(n_filters, (3, 3), padding='same', name='conv10_1', kernel_initializer='he_uniform',
                   bias_initializer='he_uniform')(up8)
    actv8 = LeakyReLU(name='actv10_1')(conv8)
    conv8 = Conv2D(n_filters, (3, 3), padding='same', name='conv10_2', kernel_initializer='he_uniform',
    ...
    # Block11
    n_filters //= growth_factor
    up9 = concatenate([Conv2DTranspose(n_filters, (2, 2), strides=(2, 2), padding='same', name='up11')(conv8), actv1],
                      name='concat11')
    conv9 = Conv2D(n_filters, (3, 3), padding='same', name='conv11_1', kernel_initializer='he_uniform',
                   bias_initializer='he_uniform')(up9)
    actv9 = LeakyReLU(name='actv11_1')(conv9)
    conv9 = Conv2D(n_filters, (3, 3), padding='same', name='conv11_2', kernel_initializer='he_uniform',
