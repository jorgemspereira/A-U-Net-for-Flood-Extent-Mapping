...
def maxavgpool(input_tensor):
    ...
    y = MaxPooling2D(pool_size=(2, 2))(input_tensor)
    z = Conv2D(filters=1, kernel_size=(2, 2), strides=(2, 2), kernel_initializer='zeros', bias_initializer='zeros', activation='sigmoid')(input_tensor)
    zx = Multiply()([x, z])
